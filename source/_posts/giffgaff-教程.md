...
1.  先不要插卡，浏览器清空缓存重启，建议无痕模式，打开 [https://www.giffgaff.com/activate](https://www.giffgaff.com/activate) 输入卡片上 6 位激活码，点击 **Activate your SIM**。 ![](/assets/giffgaff/182f211df067ea40.png)
    
2.  输入邮箱，点击 **Next**。 ![](/assets/giffgaff/c25b13523a4f518d.png)
    
3.  输入邮箱收到的验证码，点击 **Confirm**。 ![](/assets/giffgaff/aec94b0666b9747c.png)
    
4.  创建密码，点击 **Register**。 ![](/assets/giffgaff/c3e2767c6e986ef8.png)
    
5.  选择 **No,thanks**，点击 **Continue**。 ![](/assets/giffgaff/2d64e565a2afc3ea.png)
    
6.  网页下拉至最底部选择 **Pay as you go**，点击 **Continue**。 ![](/assets/giffgaff/7cf986d54329492e.png)
    
7.  选择 10 英镑，点击 **Pay now**，使用多币种信用卡（VISA 或 MasterCard）进行充值。  
    注：若没有信用卡， 联系客服购买充值卡，点击 **Or redeem a top-up voucher**，在 **Voucher code** 里输入 16 位充值卡密。 ![](/assets/giffgaff/278e1ad178bb5334.png)
    
8.  填写姓名（现实中存在的英文名）和地址（谷歌地图搜个英国地址），点击 **Continue**。 ![](/assets/giffgaff/4a3626c5330b445e.png)
    
9.  输入信用卡信息，勾选 **I understand and agree**， 点击 **Place order**。  
    注： 若用充值卡激活，不需要填写信用卡信息。 ![](/assets/giffgaff/26c6a5a0052f50a5.png)
    
10.  出现的号码就是你的手机号（英国区号 +44）。 ![](/assets/giffgaff/89126623a3e23e5a.png)
     
11.  回到主页，显示余额表示已激活，插卡等待有信号即可。  
     如果未显示余额表示还在激活中（一般 30 分钟至几小时，最慢不超过 24 小时），激活成功官方也会发邮箱通知你。 ![](/assets/giffgaff/ffdf584c7789367a.png)
